...
namespace SupermarketApi.WebApi.Migrations
{
            ...
            */
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityInPackage = table.Column<short>(type: "smallint", nullable: true),
                    UnitOfMeasurement = table.Column<string>(type: "enum('Unity','Milligram','Gram','Kilogram','Liter')", nullable: false),
